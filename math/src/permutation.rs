...
mod wrap {
    ...
    pub type PermutationsImpl<const N: usize> = impl Iterator<Item = (Parity, [usize; N])>;

    pub fn permutations_impl<const N: usize>() -> PermutationsImpl<N> {
...
pub struct Permutations<const N: usize>(wrap::PermutationsImpl<N>);
